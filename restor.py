...
# Требования:
# использовать инкапсуляцию (__ и _)
# использовать наследование (Dish → HotDish, Dessert, Drink)
# использовать полиморфизм (разные реализации info())
# использовать *args и **kwargs в Kitchen 